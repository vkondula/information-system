...
function get_examination_expirations(){
    $req = '
        ...
        P.id_rc as "id", N.datum_cas AS "date" , V.expirace AS "exp"
        FROM PACIENT P, TERMIN N, TERMIN_VYKON TV, VYKON V
        WHERE N.id_pacient = P.id_rc AND TV.id_vykonu = V.id_vykonu AND TV.id_terminu = N.id_terminu
        ORDER BY N.datum_cas ASC;';
    $vals = array("%".$name."%");
